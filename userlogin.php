...
<body style="background-size: cover;
    background-image: url(polsiren.jpg);
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h1 style="color: #aaa;">User Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color: #aaa;">Password</h1></label>
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Fareeha Disha</b></h4>
</div>
