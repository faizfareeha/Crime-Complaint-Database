...
<body style="background-size: cover;
    background-image: url(cidlogo.jpg);
...
<body>
 ...
 <div class="container">
 	<div class="row">
 		<div class="col-lg-12">
 			<div class="content">
        <h1 style="color: #aaa"> CRIME COMPLAINT DATABASE </h1>
        <p> <br> </br></p>
 				<h2>Have a Complaint?</h2>
 				<h3>Register Below &nbsp &nbsp<i class="fa fa-hand-o-down" aria-hidden="true"></i></h3>
 				<hr>
          <a href="registration.php" class="btn btn-default btn-lg" role="button" aria-pressed="true" style="color: #000">Sign Up!</a>
 			</div>
 		</div>
 	</div>
 </div>
